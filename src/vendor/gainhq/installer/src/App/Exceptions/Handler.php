...
namespace Gainhq\Installer\App\Exceptions;

use Exception;
use Gainhq\Installer\App\Exceptions\Traits\ExceptionHelper;
        ...
        if(!$request->expectsJson() && app()->environment('production')){
            ...
            if(view()->exists('custom_errors.'.$statusCode)) {
                ...
                if ($exception instanceof Swift_TransportException) {
                    $message = trans('default.incorrect_delivery_credential', ['resource' => trans('default.incorrect_delivery_credential')]);
                }
